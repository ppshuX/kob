        ...
        <div class="row">
            <div class="col-3">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-body">
                        <img :src="$store.state.user.photo" alt="photo" style="width: 100%;">
                    </div>
                </div>
            </div>
            <div class="col-9">
                        ...
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea v-model="botadd.description" class="form-control" id="add-bot-title" placeholder="请输入Bot简介"></textarea>
                                </div>
                                <div class="mb-3">
